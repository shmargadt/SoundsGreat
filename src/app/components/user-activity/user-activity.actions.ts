...
@Injectable()
export class UserActivityActions implements OnInit {

  results: string[];
  static FETCH_USER_ACTIVITY = 'FETCH_USER_ACTIVITY';
  static FETCH_TEST = 'FETCH_TEST';

  constructor(private ngRedux: NgRedux<IUserActivityState>,private http: Http) {}

  ngOnInit(): void {
    // Make the HTTP request:
    this.http.get('/logger/keyboard.json').subscribe(data => {
